          ...
          >
            <div className="flex items-center justify-between">
              ...
              {alreadySaved?.length !== 0 ? (
                ...
                type="button" className="bg-gradient-to-r from-green-400 to-blue-500 opacity-70 hover:opacity-100 text-white font-bold px-5 py-1 text-base rounded-3xl hover:shadow-md outline-none">
                ...
                <button
                  ...
                  type="button"
                  className=" bg-gradient-to-r from-[#b14b72] to-[#7ac8db] opacity-70 hover:opacity-100 text-white font-bold px-5 py-1 text-base rounded-3xl hover:shadow-md outline-none"
                >
